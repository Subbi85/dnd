...
import imageOne from "../assets/header.jpg"
    ...
    <>
     <div id="default-carousel" className="relative w-full" data-carousel="slide">
          <div className="relative h-56 overflow-hidden rounded-lg md:h-96">
            ...
            <img src={imageOne} className="w-full h-auto" alt="Header" />
            </div>
            <div className=" duration-700 ease-in-out" data-carousel-item>
              <img src={imageOne} className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..." />
            </div>
            <div className=" duration-700 ease-in-out" data-carousel-item>
              <img src={imageOne} className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..." />
            </div>
